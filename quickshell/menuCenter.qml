            ...
            Column {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            launcher.command = ["sh", "-c", "quickshell -p ~/.config/quickshell/wallpaper.qml"];
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            launcher.command = ["sh", "-c", "quickshell -p ~/.config/quickshell/ConfigMenu.qml"];
                            launcher.running = true;
                            menuWindow.visible = false;
                        }
                    }
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            launcher.command = ["sh", "-c", "rofi -show drun"];
                            launcher.running = true;
                            menuWindow.visible = false;
                        }
                    }
